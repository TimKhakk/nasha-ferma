...
const FooterMiddle = () => {
	const { changeCategory } = useStoreContext();
	return (
		<div className='footer-middle'>
			<Container>
				<div className='footer-middle__row'>
					<div className='footer-middle__item'>
						<Link to='/products' className='footer-middle__title'>
							Продукты
						</Link>
						<ul className='footer-middle__list'>
							...
							<li className='footer-middle__li'>
								<Link
									to='/products'
									onClick={() => changeCategory('Молочные продукты')}
									className='footer-middle__link'
								>
									Молочные продукты
								</Link>
							...
							<li className='footer-middle__li'>
								<Link
									to='/products'
									onClick={() => changeCategory('Мёд и варенье')}
									className='footer-middle__link'
								>
									Мёд и варенье
								</Link>
					...
					<div className='footer-middle__item'>
						...
						<ul className='footer-middle__list'>
							...
							<li className='footer-middle__li'>
								<span className='footer-middle__link'>
									Показать все
									<svg
