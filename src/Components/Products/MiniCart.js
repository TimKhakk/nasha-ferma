						...
						<div key={id} className="mini-cart-item">
							...
							>
								<svg className="mini-cart-item__delete-btn-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19">
									<path fillRule="evenodd" clipRule="evenodd" d="M9.695 17.417c-1.072 0-2.118-.012-3.153-.034-1.324-.026-2.24-.884-2.39-2.24-.249-2.248-.675-7.547-.68-7.6a.593.593 0 01.545-.64c.322-.008.613.218.64.544.003.054.43 5.335.676 7.566.085.77.5 1.168 1.234 1.183 1.979.042 3.998.044 6.175.005.78-.015 1.2-.405 1.288-1.193.245-2.212.673-7.507.677-7.56.026-.327.315-.555.64-.545.326.027.57.313.544.64-.005.054-.434 5.367-.681 7.595-.154 1.383-1.067 2.225-2.446 2.25-1.056.018-2.074.029-3.069.029zm6.699-11.884H2.969a.594.594 0 010-1.187h13.425a.594.594 0 010 1.187z" />
									<path fillRule="evenodd" clipRule="evenodd" d="M13.807 5.533a1.904 1.904 0 01-1.86-1.525l-.193-.963c-.04-.146-.207-.274-.397-.274H8.006a.419.419 0 00-.406.31l-.184.927a1.903 1.903 0 01-1.86 1.525.594.594 0 010-1.187c.337 0 .63-.241.696-.572l.192-.963c.196-.737.835-1.227 1.562-1.227h3.35c.728 0 1.366.49 1.554 1.192l.201.998a.713.713 0 00.696.572.594.594 0 010 1.187z" />
								</svg>
							</button>
				...
				{cart.length === 0 ?
					<div className="mini-cart_empty">
						<svg width="66" height="65" viewBox="0 0 66 65" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<path fillRule="evenodd" clipRule="evenodd" d="M17.5195 58.2812C18.4978 58.2812 19.2875 59.0709 19.2875 60.0492C19.2875 61.0274 18.4978 61.8204 17.5195 61.8204C16.538 61.8204 15.7483 61.0274 15.7483 60.0492C15.7483 59.0709 16.538 58.2812 17.5195 58.2812" fill="#9F9F9F"/>
							<path fillRule="evenodd" clipRule="evenodd" d="M17.5163 64.2576C15.1958 64.2576 13.3108 62.3693 13.3108 60.0488C13.3108 57.7283 15.1958 55.8433 17.5163 55.8433C19.8368 55.8433 21.725 57.7283 21.725 60.0488C21.725 62.3693 19.8368 64.2576 17.5163 64.2576" fill="#9F9F9F"/>
